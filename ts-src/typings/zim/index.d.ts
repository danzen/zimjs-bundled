...
// 3. All code from GLOBALS to END GLOBALS gets copied to and ed from the zim namespace declaration
...
declare global {
    ...
    function chop(obj: DisplayObject, cols?: number, rows?: number, tile?: boolean, margin?: number): zim.Tile | [zim.Bitmap]
    ...
    function timeout(time: number | zimVee, call: Function): { pause: Function, clear: Function, time: number, paused: boolean, done: boolean }
    function interval(time: number | zimVee, call: Function, total?: number, immediate?: boolean): { pause: Function, clear: Function, time: number, count: number, total: number, paused: boolean, pauseTimeLeft: number }
    ...
    function asset(file: string): DisplayObject
    ...
    function convertColor(color: color, toColorType?: string, alpha?: number): string
    ...
    function asset(file: string, width?: number, height?: number): DisplayObject
    function object(name: string): DisplayObject
  ...
  interface zimDisplay {
    ...
    noHold(): this
    drag(config_or_boundary?: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number } | DisplayObject, overCursor?: string, dragCursor?: string, all?: boolean, swipe?: boolean, localBounds?: boolean, onTop?: boolean, surround?: boolean, slide?: boolean, slideDamp?: number, slideSnap?: boolean, reg?: boolean, removeTweens?: boolean, startBounds?: boolean, rect?: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number }, currentTarget?: boolean): this
    drag(config: { boundary?: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number } | DisplayObject, overCursor?: string, dragCursor?: string, all?: boolean, swipe?: boolean, localBounds?: boolean, onTop?: boolean, surround?: boolean, slide?: boolean, slideDamp?: number, slideSnap?: boolean, reg?: boolean, removeTweens?: boolean, startBounds?: boolean, rect?: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number }, currentTarget?: boolean }): this
    noDrag(): this
    dragBoundary(boundary: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number }): this
    dragRect(boundary: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number }): this
    mouse(): this
    noMouse(): this
    ...
    noWired(): this
    bind(config_or_id: string, props?: [any] | {} | string, extra?: string | number, filter?: Function, bindObj?: zim.Bind): this
    bind(config: { id: string, props?: [any] | {} | string, extra?: string | number, filter?: Function, bindObj?: zim.Bind }): this
    noBind(config_or_props?: [any] | {} | string, removeConnectionData?: boolean, call?: Function, bindObj?: zim.Bind): this
    noBind(config: { props?: [any] | {} | string, removeConnectionData?: boolean, call?: Function, bindObj?: zim.Bind }): this
    ...
    gesture(config_or_move?: boolean, scale?: boolean, rotate?: boolean, boundary?: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number }, minScale?: number, maxScale?: number, snapRotate?: number, localBounds?: boolean, slide?: boolean, slideEffect?: number, regControl?: boolean, onTop?: boolean, surround?: boolean, circularBounds?: boolean, rect?: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number }): this
    gesture(config: { move?: boolean, scale?: boolean, rotate?: boolean, boundary?: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number }, minScale?: number, maxScale?: number, snapRotate?: number, localBounds?: boolean, slide?: boolean, slideEffect?: number, regControl?: boolean, onTop?: boolean, surround?: boolean, circularBounds?: boolean, rect?: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number } }): this
    ...
    gestureBoundary(boundary: zim.Boundary | createjs.Rectangle | { x: number, y: number, width: number, height: number }, update?: boolean): this
    addPhysics(config_or_dynamic?: boolean, contract?: number, shape?: string, friction?: number, linear?: number, angular?: number, density?: number, restitution?: number, maskBits?: number, categoryBits?: number, physics?: zim.Physics): this
    addPhysics(config: { dynamic?: boolean, contract?: number, shape?: string, friction?: number, linear?: number, angular?: number, density?: number, restitution?: number, maskBits?: number, categoryBits?: number, physics?: zim.Physics }): this
    removePhysics(): this
    ...
    pos(config_or_x?: number, y?: number, right?: boolean | string, bottom?: boolean | string, container?: zim.Container | zim.Stage, index?: number, add?: boolean, reg?: boolean, regX?: boolean, regY?: boolean): this
    pos(config: { x?: number, y?: number, right?: boolean | string, bottom?: boolean | string, container?: zim.Container | zim.Stage, index?: number, add?: boolean, reg?: boolean, regX?: boolean, regY?: boolean }): this
    loc(config_or_target_or_x?: {} | [] | DisplayObject | zim.Point | number, y?: number, container?: zim.Container | zim.Stage, index?: number, add?: boolean, localToLocal?: boolean, x?: number): this
    loc(config: { target_or_x?: {} | [] | DisplayObject | zim.Point | number, y?: number, container?: zim.Container | zim.Stage, index?: number, add?: boolean, localToLocal?: boolean, x?: number }): this
    ...
    addTo(config_or_container?: zim.Container | zim.Stage, index?: number, localToLocal?: boolean): this
    addTo(config: { container?: zim.Container | zim.Stage, index?: number, localToLocal?: boolean }): this
    removeFrom(container?: zim.Container | zim.Stage): this
    added(call: Function, interval?: number, maxTime?: number): string
    centerReg(config_or_container?: zim.Container | zim.Stage, index?: number, add?: boolean): this
    centerReg(config: { container?: zim.Container | zim.Stage, index?: number, add?: boolean }): this
    center(config_or_container?: zim.Container | zim.Stage, index?: number, add?: boolean): this
    center(config: { container?: zim.Container | zim.Stage, index?: number, add?: boolean }): this
