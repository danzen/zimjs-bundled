...
/// <reference types="../createjs-lib/index.d.ts" />
/// <reference types="../easeljs/index.d.ts" />
/// <reference types="../preloadjs/index.d.ts" />
/// <reference types="../soundjs/index.d.ts" />
/// <reference types="../tweenjs/index.d.ts" />
...
declare function loop(obj: number | {} | [any] | Dictionary, call: Function, reverse?: boolean, interval?: number, step?: number, start?: number, end?: number): any
